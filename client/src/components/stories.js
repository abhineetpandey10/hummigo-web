...
export default function Stories(props)
{
    ...
    async function showPost(dpurl,author,head,body,imgurl)
    {
        ...
        fetch("https://hummigo-server.herokuapp.com/stories/upvote", requestOptions)
    ...
    async function handleUpvote()
    {
        ...
        else
        {
            ...
            fetch("https://hummigo-server.herokuapp.com/stories/downvote", requestOptions)
            .then(response =>{response.text();setUpdating(false)})
            .then(result => {
                console.log(result);
            })
    ...
    async function fetchData()
    {
        ...
        var url="https://hummigo-server.herokuapp.com/stories/view?email="+email;
        console.log(url);
    ...
    <div>
        ...
        <div className="imghead">
            ...
            <div id="write" onClick={()=>setFormOpen(true)}>
                ...
                <span>Publish your own stories</span>
            </div>
            <div id="filler"></div>
            ...
            <Dialog open={formOpen}>
                ...
                <Form dpurl={dpurl} name={name} context="stories"/>
            </Dialog>
