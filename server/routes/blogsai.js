...
.post((req,res)=>{
    ...
    python.on('close', (code) => 
    {
        ...
        connectDB();
        console.log("Connected to database through /blogs/write");
        var blogdata={
            name:name,
            email:email,
            dpurl:dpurl,
...
.post((req,res)=>{
    ...
    python.on('close', (code) => 
    {
        ...
        connectDB();
        console.log("Connected to database through  /blogs/upvote");
        ...
        .then(data=>{
            ...
            User.updateOne({email:email},{blogpreferences:userPrefArr})
            .then(()=>{
...
.post((req,res)=>{
    ...
    python.on('close', (code) => 
    {
        ...
        connectDB();
        console.log("Connected to database through  /blogs/downvote");
